...
FUNC_SET_FILE() {
    ...
    cat $DIRS1 | grep "mainnet_httpUrl"
    cat $DIRS2 | grep "mainnet_httpUrl"
    cat $DIRS3 | grep "httpUrl"
...
FUNC_SED_FILE() {
    ...
    cat $DIRS1 | grep mainnet_wsUrl
    cat $DIRS2 | grep mainnet_wsUrl
    cat $DIRS3 | grep wsUrl
}
